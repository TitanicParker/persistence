...
.cg-developmental-gateway{margin:3rem 0 0;padding:1.35rem 1.45rem;background:#f4f0e8;border-left:4px solid #2f5d50}.cg-developmental-gateway p{margin:.35rem 0}.cg-developmental-gateway__eyebrow{font:700 .72rem/1.4 ui-sans-serif,system-ui,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#68645d}.cg-developmental-gateway__link{display:inline-block;margin-top:.65rem;font:700 .88rem/1.4 ui-sans-serif,system-ui,sans-serif;text-underline-offset:.2em}
...
const developmentalGateway = `<section class="cg-developmental-gateway" aria-labelledby="cg-developmental-gateway-title"><p class="cg-developmental-gateway__eyebrow">The explanation can keep growing</p><h2 id="cg-developmental-gateway-title">Continue from here.</h2><p>The same idea can be revisited with a little more precision, without throwing away what you have just understood.</p><a class="cg-developmental-gateway__link" href="/persistence/five-year-old/6/">Continue the explanation →</a></section>`;
