export const copyrightLine = 'Copyright © 9 August 2026 Liam Moloney. All Rights Reserved.';
...
export const acknowledgementText = [
  "The publication uses a first-entry acknowledgement so that the rights status is presented before substantive reading. The acknowledgement records only that this notice has been brought to the visitor's attention; it does not itself grant additional rights.",
] as const;
